cordova.define("tealium-cordova-plugin.tealium", function(require, exports, module) {
    const Environment = {
        dev: "dev",
        qa: "qa",
        prod: "prod"
    ...
    let TealiumPlugin = {
        ...
        resetVisitorId(callback) {
            cordova.exec(callback, callback, PLUGIN_NAME, Commands.RESET_VISITOR_ID)
        },
    
        clearStoredVisitorIds(callback) {
            cordova.exec(callback, callback, PLUGIN_NAME, Commands.CLEAR_STORED_VISITOR_IDS)
        },
